...
extern int nrn_mlh_gsort(double*, int*, int, int (*)(double, double));
extern int ivoc_list_count(Object*);
extern Object* ivoc_list_item(Object*, int);
extern int list_vector_px2(Object*, int, double**, void**);
extern int list_vector_px3(Object*, int, double**, void**);
extern int list_vector_px4(Object*, int, double**, unsigned int);
...
double *list_vector_resize(Object*, int, int);
