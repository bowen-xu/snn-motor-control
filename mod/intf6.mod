...
int gsort2(double*, Point_process**, int, double*, Point_process**);
int gsort3(double*, Point_process**, char*, int, double*, Point_process**, char*);
int gsort5(double*, Point_process**, char*, double*, double*, int,
